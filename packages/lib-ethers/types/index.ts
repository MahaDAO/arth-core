...
interface BorrowerOperationsTransactions {
  ...
  openTrove(_maxFeePercentage: BigNumberish, _LUSDAmount: BigNumberish, _upperHint: string, _lowerHint: string, _frontEndTag: string, _overrides?: PayableOverrides): Promise<void>;
  ...
  setAddresses(_troveManagerAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _governanceAddress: string, _sortedTrovesAddress: string, _lusdTokenAddress: string, _overrides?: Overrides): Promise<void>;
  transferOwnership(newOwner: string, _overrides?: Overrides): Promise<void>;
...
export interface BorrowerOperations
  ...
  readonly filters: {
    ...
    OwnershipTransferred(previousOwner?: string | null, newOwner?: string | null): EventFilter;
    PaidLUSDBorrowingFeeToEcosystemFund(_ecosystemFund?: string | null, _LUSDFee?: null): EventFilter;
    PaidLUSDBorrowingFeeToFrontEnd(_frontEndTag?: string | null, _LUSDFee?: null): EventFilter;
  ...
  extractEvents(logs: Log[], name: "OwnershipTransferred"): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  extractEvents(logs: Log[], name: "PaidLUSDBorrowingFeeToEcosystemFund"): _TypedLogDescription<{ _ecosystemFund: string; _LUSDFee: BigNumber }>[];
  extractEvents(logs: Log[], name: "PaidLUSDBorrowingFeeToFrontEnd"): _TypedLogDescription<{ _frontEndTag: string; _LUSDFee: BigNumber }>[];
...
interface CommunityIssuanceTransactions {
  ...
  setAddresses(_lqtyTokenAddress: string, _stabilityPoolAddress: string, _rewardsDuration: BigNumberish, _overrides?: Overrides): Promise<void>;
  transferOwnership(newOwner: string, _overrides?: Overrides): Promise<void>;
}
...
interface StabilityPoolTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _troveManagerAddress: string, _activePoolAddress: string, _lusdTokenAddress: string, _sortedTrovesAddress: string, _governanceAddress: string, _communityIssuanceAddress: string, _overrides?: Overrides): Promise<void>;
  transferOwnership(newOwner: string, _overrides?: Overrides): Promise<void>;
...
interface TroveManagerTransactions {
  ...
  setAddresses(_borrowerOperationsAddress: string, _activePoolAddress: string, _defaultPoolAddress: string, _stabilityPoolAddress: string, _gasPoolAddress: string, _collSurplusPoolAddress: string, _governanceAddress: string, _lusdTokenAddress: string, _sortedTrovesAddress: string, _overrides?: Overrides): Promise<void>;
