...
export interface ActivePool extends _TypedLiquityContract<ActivePoolCalls, ActivePoolTransactions> {
  ...
  ): _TypedLogDescription<{ _LUSDDebt: BigNumber }>[];
  extractEvents(
    logs: Log[],
...
export interface BorrowerOperations
  ...
  ): _TypedLogDescription<{ _lqtyStakingAddress: string }>[];
  extractEvents(
    logs: Log[],
    name: "LUSDBorrowingFeePaid"
  ): _TypedLogDescription<{ _borrower: string; _LUSDFee: BigNumber }>[];
  extractEvents(
    logs: Log[],
    name: "LUSDTokenAddressChanged"
  ): _TypedLogDescription<{ _lusdTokenAddress: string }>[];
  extractEvents(
    logs: Log[],
    name: "OwnershipTransferred"
  ): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
...
export interface CommunityIssuance
  ...
  ): _TypedLogDescription<{ _lqtyTokenAddress: string }>[];
  extractEvents(
    logs: Log[],
    name: "OwnershipTransferred"
  ): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
  ...
  ): _TypedLogDescription<{ _totalLQTYIssued: BigNumber }>[];
}
...
export interface ARTHValuecoin extends _TypedLiquityContract<LUSDTokenCalls, LUSDTokenTransactions> {
  readonly filters: {
    Approval(owner?: string | null, spender?: string | null, value?: null): EventFilter;
    BorrowerOperationsAddressChanged(_newBorrowerOperationsAddress?: null): EventFilter;
...
interface LQTYStakingCalls {
  ...
  snapshots(
    arg0: string,
    _overrides?: CallOverrides
  ): Promise<{ F_ETH_Snapshot: BigNumber; F_LUSD_Snapshot: BigNumber }>;
...
export interface LQTYStaking
  ...
  ): _TypedLogDescription<{ _staker: string; _F_ETH: BigNumber; _F_LUSD: BigNumber }>[];
  extractEvents(
    logs: Log[],
    name: "StakingGainsWithdrawn"
  ): _TypedLogDescription<{ staker: string; LUSDGain: BigNumber; ETHGain: BigNumber }>[];
  extractEvents(
    logs: Log[],
    name: "TotalLQTYStakedUpdated"
  ): _TypedLogDescription<{ _totalLQTYStaked: BigNumber }>[];
  extractEvents(
    logs: Log[],
...
export interface StabilityPool
  ...
  ): _TypedLogDescription<{ _depositor: string; _ETH: BigNumber; _LUSDLoss: BigNumber }>[];
  extractEvents(
    logs: Log[],
    name: "EpochUpdated"
  ...
  ): _TypedLogDescription<{ _depositor: string; _LQTY: BigNumber }>[];
  extractEvents(
    logs: Log[],
    name: "LQTYPaidToFrontEnd"
  ): _TypedLogDescription<{ _frontEnd: string; _LQTY: BigNumber }>[];
  extractEvents(
    logs: Log[],
    name: "LUSDTokenAddressChanged"
  ): _TypedLogDescription<{ _newLUSDTokenAddress: string }>[];
  extractEvents(
    logs: Log[],
    name: "OwnershipTransferred"
  ): _TypedLogDescription<{ previousOwner: string; newOwner: string }>[];
...
interface TroveManagerCalls {
  ...
  rewardSnapshots(
    arg0: string,
    _overrides?: CallOverrides
  ): Promise<{ ETH: BigNumber; LUSDDebt: BigNumber }>;
  sortedTroves(_overrides?: CallOverrides): Promise<string>;
...
export interface TroveManager
  ...
  extractEvents(
    logs: Log[],
    name: "LTermsUpdated"
  ): _TypedLogDescription<{ _L_ETH: BigNumber; _L_LUSDDebt: BigNumber }>[];
  extractEvents(
    logs: Log[],
    name: "LUSDTokenAddressChanged"
  ): _TypedLogDescription<{ _newLUSDTokenAddress: string }>[];
