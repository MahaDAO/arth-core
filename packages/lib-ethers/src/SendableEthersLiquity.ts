...
/**
 * Ethers-based implementation of {@link @mahadao/arth-base#SendableLiquity}.
 *
 * @public
 */
  ...
  implements SendableLiquity<EthersTransactionReceipt, EthersTransactionResponse>
{
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.openTrove} */
  async openTrove(
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.closeTrove} */
  closeTrove(
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.adjustTrove} */
  adjustTrove(
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.depositCollateral} */
  depositCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.withdrawCollateral} */
  withdrawCollateral(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.borrowARTH} */
  borrowARTH(
    amount: Decimalish,
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.repayARTH} */
  repayARTH(
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ): Promise<SentEthersLiquityTransaction<TroveAdjustmentDetails>> {
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.liquidate} */
  liquidate(
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.liquidateUpTo} */
  liquidateUpTo(
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.depositARTHInStabilityPool} */
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.withdrawARTHFromStabilityPool} */
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.withdrawGainsFromStabilityPool} */
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.transferCollateralGainToTrove} */
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.sendARTH} */
  sendARTH(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.sendMAHA} */
  sendMAHA(
    toAddress: string,
    amount: Decimalish,
    overrides?: EthersTransactionOverrides
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.redeemARTH} */
  redeemARTH(
    amount: Decimalish,
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.claimCollateralSurplus} */
  ...
  /** {@inheritDoc @mahadao/arth-base#SendableLiquity.registerFrontend} */
  registerFrontend(
