...
contract("SortedTroves", async accounts => {
  ...
  //     await borrowerOperations.openTrove(th._100pct, 0, whale, whale, ZERO_ADDRESS, { from: whale, value: dec(50, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, 0, A, A, ZERO_ADDRESS, { from: A, value: dec(1, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, 0, B, B, ZERO_ADDRESS, { from: B, value: dec(37, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, 0, C, C, ZERO_ADDRESS, { from: C, value: dec(5, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, 0, D, D, ZERO_ADDRESS, { from: D, value: dec(4, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, 0, E, E, ZERO_ADDRESS, { from: E, value: dec(19, 'ether') });

  //     // Make some troves with non-zero debt, in random order
  //     await borrowerOperations.openTrove(th._100pct, dec(5, 19), F, F, ZERO_ADDRESS, { from: F, value: dec(1, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, dec(3, 18), G, G, ZERO_ADDRESS, { from: G, value: dec(37, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, dec(2, 20), H, H, ZERO_ADDRESS, { from: H, value: dec(5, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, dec(17, 18), I, I, ZERO_ADDRESS, { from: I, value: dec(4, 'ether') });
  //     await borrowerOperations.openTrove(th._100pct, dec(5, 21), J, J, ZERO_ADDRESS, { from: J, value: dec(1345, 'ether') });
  ...
  //     await borrowerOperations.openTrove(th._100pct, dec(100, 18), defaulter_1, defaulter_1, ZERO_ADDRESS, { from: defaulter_1, value: dec(1, 'ether') });
