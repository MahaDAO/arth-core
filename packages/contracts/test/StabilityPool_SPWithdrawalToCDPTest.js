...
contract("StabilityPool - Withdrawal of stability deposit - Reward calculations", async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawETHGainToTrove(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedARTHDeposit(bob)).toString(),
          "6666666666666666666666"
        ),
        10000
      );
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedARTHDeposit(carol)).toString(),
          "6666666666666666666666"
        ),
        10000
      );
    ...
    it("withdrawETHGainToTrove():  Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(alice)).toString(), "0"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(bob)).toString(), "0"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(carol)).toString(), "0"),
        10000
      );
    ...
    it("withdrawETHGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 ARTH.  A, B, C, D withdraw correct ARTH deposit and ETH Gain", async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedARTHDeposit(dennis)).toString(),
          "5000000000000000000000"
        ),
        100000
      );
    ...
    it("withdrawETHGainToTrove(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. All deposits and liquidations = 100 ARTH.  A, B, C, D withdraw correct ARTH deposit and ETH Gain", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(dennis)).toString(), "0"),
        100000
      );
    ...
    it("withdrawETHGainToTrove(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(
        th.getDifference(
          (await stabilityPool.getCompoundedARTHDeposit(erin)).toString(),
    ...
    it("withdrawETHGainToTrove(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(erin)).toString(), "0"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(flyn)).toString(), "0"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(graham)).toString(), "0"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(harriet)).toString(), "0"),
        100000
      );
    ...
    it("withdrawETHGainToTrove(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await stabilityPool.getCompoundedARTHDeposit(bob)).toString(), dec(1, 17)),
        100000
      );
