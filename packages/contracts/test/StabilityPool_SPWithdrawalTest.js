...
contract("StabilityPool - Withdrawal of stability deposit - Reward calculations", async accounts => {
  ...
  describe("Stability Pool Withdrawal", async () => {
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "6666666666666666666666"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "6666666666666666666666"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "6666666666666666666666"),
        10000
      );
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "3333333333333333333333"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "3333333333333333333333"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "3333333333333333333333"),
        10000
      );
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after two liquidations of increasing ARTH", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "6000000000000000000000"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "6000000000000000000000"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "6000000000000000000000"),
        10000
      );
    ...
    it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct compounded deposit and ETH Gain after three liquidations of increasing ARTH", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "4000000000000000000000"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "4000000000000000000000"),
        10000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "4000000000000000000000"),
        10000
      );
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after two identical liquidations", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "13333333333333333333333"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "20000000000000000000000"),
        100000
      );
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three identical liquidations", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "5000000000000000000000"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "10000000000000000000000"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "15000000000000000000000"),
        100000
      );
    ...
    it("withdrawFromSP(): Depositors with varying deposits withdraw correct compounded deposit and ETH Gain after three varying liquidations", async () => {
      ...
      */
      ...
      // ()
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "901719380174061000000"),
        100000000000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "205592018679686000000000"),
        10000000000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "5906261940140100000000"),
        10000000000
      );
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 1 liquidation. All deposits and liquidations = 100 ARTH.  A, B, C, D withdraw correct ARTH deposit and ETH Gain", async () => {
      ...
      console.log();
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "1666666666666666666666"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "1666666666666666666666"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "1666666666666666666666"),
        100000
      );

      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), "5000000000000000000000"),
        100000
      );
    ...
    it("withdrawFromSP(): A, B, C Deposit -> 2 liquidations -> D deposits -> 2 liquidations. Various deposit and liquidation vals.  A, B, C, D withdraw correct ARTH deposit and ETH Gain", async () => {
      ...
      */
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "17832817337461300000000"),
        100000000000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "5944272445820430000000"),
        100000000000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "4458204334365320000000"),
        100000000000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), "11764705882352900000000"),
        100000000000
      );
    ...
    it("withdrawFromSP(): A, B, C, D deposit -> 2 liquidations -> D withdraws -> 2 liquidations. Various deposit and liquidation vals. A, B, C, D withdraw correct ARTH deposit and ETH Gain", async () => {
      ...
      */
      ...
      const dennis_ETHWithdrawn = th.getEventArgByName(txD, "ETHGainWithdrawn", "_ETH").toString();
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), "27692307692307700000000"),
        100000000000
      );
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "1672240802675590000000"),
        10000000000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "2090301003344480000000"),
        100000000000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "1045150501672240000000"),
        100000000000
      );
    ...
    it("withdrawFromSP(): A, B, D deposit -> 2 liquidations -> C makes deposit -> 1 liquidation -> D withdraws -> 1 liquidation. All deposits: 100 ARTH. Liquidations: 100,100,100,50.  A, B, C, D withdraw correct ARTH deposit and ETH Gain", async () => {
      ...
      const dennis_ETHWithdrawn = th.getEventArgByName(txD, "ETHGainWithdrawn", "_ETH").toString();
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), "1666666666666666666666"),
        100000
      );
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(alice)).toString(), "666666666666666666666"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "666666666666666666666"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "2000000000000000000000"),
        100000
      );
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "5000000000000000000000"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), "5000000000000000000000"),
    ...
    it("withdrawFromSP(): Depositors withdraw correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), "8333333333333333333333"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), "16666666666666666666666"),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(erin)).toString(), "25000000000000000000000"),
        100000
      );
    ...
    it("withdrawFromSP(): Depositor withdraws correct compounded deposit after liquidation empties the pool", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(harriet)).toString(), "0"),
        100000
      );
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), "100000000000000000000"),
        100000
      );
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraw correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      */
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), dec(100, 18)),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), dec(200, 18)),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), dec(300, 18)),
        100000
      );
    ...
    it("withdrawFromSP(): deposit spans one scale factor change: Single depositor withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(bob)).toString(), dec(1, 17)),
        100000
      );
    ...
    it("withdrawFromSP(): Several deposits of varying amounts span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(carol)).toString(), dec(2, 17)),
        100000
      );
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), dec(3, 17)),
        100000
      );
    ...
    */
    it("withdrawFromSP(): Several deposits of 10000 ARTH span one scale factor change. Depositors withdraws correct compounded deposit and ETH Gain after one liquidation", async () => {
      ...
      assert.isAtMost(
        th.getDifference((await arthToken.balanceOf(dennis)).toString(), dec(99999, 12)),
        100000
      );
