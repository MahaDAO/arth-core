...
contract('TroveManager', async accounts => {
  ...
  it("11 accounts with random coll. 1 liquidation. 10 accounts do Trove operations (apply rewards)", async () => {
    await borrowerOperations.openTrove(0, 0, accounts[99], ZERO_ADDRESS, { from: accounts[99], value: dec(100, 'ether') })
    await borrowerOperations.openTrove(0, dec(170, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0], value: dec(1, 'ether') })
  ...
  */
  ...
  it("101 accounts with random coll. 1 liquidation. 100 accounts do a Trove operation (apply rewards)", async () => {
    await borrowerOperations.openTrove(0, 0, accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(1000, 'ether') })
    await borrowerOperations.openTrove(0, dec(170, 18), accounts[0], ZERO_ADDRESS, { from: accounts[0], value: dec(1, 'ether') })
 ...
 it("11 accounts with random ETH and proportional LUSD (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  await borrowerOperations.openTrove(0, 0,  accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(100, 'ether') })
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 LUSD
     ...
     await borrowerOperations.openTrove(0, dec(100, 18), accounts[0], ZERO_ADDRESS,{from: accounts[0], value: dec(1, 'ether')})
...
it("11 accounts with random ETH and proportional LUSD (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
  await borrowerOperations.openTrove(0, 0,  accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(1, 27) })
...
/* 
  ...
  */
  ...
  it("101 accounts with random ETH and proportional LUSD (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openTrove(0, 0,  accounts[999], ZERO_ADDRESS, { from: accounts[999], value: dec(1, 28) })
