...
const ABDKOperations = async () => {
  ...
  console.log(`result of 0.5 * 6, performed in 64.64, converted back to uint64: ${res12}`);
    ...
    // Example computaton: ARTH -> Ether price conversion

    // price = 200.12345678, stored as uint
    // convert 6123456700909.123456789123456789 ARTH to Ether
    // amount = 6123456700909.123456789123456789 ARTH / 200.12345678 
  ...
  // accurate to 17 digits
    ...
    /* TODO: will L_ETH, L_ARTH overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
