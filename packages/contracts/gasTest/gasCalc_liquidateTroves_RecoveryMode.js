...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 900 ARTH
    ...
    //1 accts open Trove with 1 ether and withdraw 100 ARTH
    ...
    // Account 500 opens with 1 ether and withdraws 100 ARTH
    await borrowerOperations.openTrove(_100pct, dec(60, 18), accounts[500], ZERO_ADDRESS, ZERO_ADDRESS)
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 ether and withdraw 100 ARTH
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 ether and withdraw 100 ARTH
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 ether and withdraw 100 ARTH
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 ether and withdraw 100 ARTH
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 90 ARTH
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'ether'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 ether and withdraw 100 ARTH
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 ether and withdraw 100 ARTH
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 ether and withdraw 100 ARTH
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(_100pct, dec(9500, 18), accounts[500], ZERO_ADDRESS, ZERO_ADDRESS)
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion ARTH
    const whale = accounts[999]
    await borrowerOperations.openTrove(_100pct, dec(9, 28), whale,ZERO_ADDRESS, ZERO_ADDRESS)
    await stabilityPool.provideToSP(dec(9, 28), ZERO_ADDRESS, { from: whale })

    // Check SP has 9e28 ARTH
    const LUSDinSP = (await stabilityPool.getTotalLUSDDeposits()).toString()
    assert.equal(LUSDinSP, dec(9, 28))

    //1 acct opens Trove with 1 ether and withdraw 100 ARTH
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'ether'), dec(60, 18))
    ...
    //Check ARTH in SP has decreased but is still > 0
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 ether and withdraw 100 ARTH
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'ether'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 ether and withdraw 100 ARTH
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'ether'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 ether and withdraws 110 ARTH
    await borrowerOperations.openTrove(_100pct, dec(110, 18), accounts[500],ZERO_ADDRESS, ZERO_ADDRESS)
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    // Account 500 opens
    await borrowerOperations.openTrove(_100pct, dec(11000, 18), accounts[500],ZERO_ADDRESS, ZERO_ADDRESS)
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraws ARTH

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'ether'), dec(13000, 18))

    // Account 500 opens with 1 ether and withdraws ARTH
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500],ZERO_ADDRESS, ZERO_ADDRESS)
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 ether, withdraw 180 ARTH

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(100, 'ether'), dec(13000, 18))

    // Account 500 opens with 1 ether and withdraws 180 ARTH
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS,ZERO_ADDRESS)
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion ARTH
    await borrowerOperations.openTrove(_100pct, dec(1, 27), accounts[999],ZERO_ADDRESS, ZERO_ADDRESS)
