 ...
 *
 * @remarks
 * Implemented by {@link @mahadao/arth-ethers#SentEthersLiquityTransaction}.
 *
 * @public
 */
export interface SentLiquityTransaction<S = unknown, T extends LiquityReceipt = LiquityReceipt> {
   ...
   *
   * @remarks
   * Unlike {@link @mahadao/arth-base#SentLiquityTransaction.waitForReceipt | waitForReceipt()},
 ...
 *
 * Implemented by {@link @mahadao/arth-ethers#SendableEthersLiquity}.
 *
 * @public
 */
