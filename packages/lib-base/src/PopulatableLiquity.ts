 ...
 *
 * @remarks
 * Implemented by {@link @mahadao/arth-ethers#PopulatedEthersLiquityTransaction}.
 *
 * @public
 */
...
> {
   ...
   *
   * @returns An object that implements {@link @mahadao/arth-base#SentLiquityTransaction}.
   */
  send(): Promise<T>;
}
 ...
 *
 * When {@link @mahadao/arth-base#PopulatableLiquity.redeemARTH | redeemARTH()} is called with an
 ...
 *
 * Implemented by {@link @mahadao/arth-ethers#PopulatableEthersLiquity}.
 *
 * @public
 */
