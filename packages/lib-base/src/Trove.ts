...
/**
 * Parameters of an {@link TransactableARTH.openTrove | openTrove()} transaction.
 *
 * @remarks
...
/**
 * Parameters of a {@link TransactableARTH.closeTrove | closeTrove()} transaction.
 *
 * @remarks
...
/**
 * Parameters of an {@link TransactableARTH.adjustTrove | adjustTrove()} transaction.
 *
 * @remarks
...
export class Trove {
   ...
   *
   * @example
   * Can be used to check whether the ARTH protocol is in recovery mode by using it on the return
   * value of {@link ReadableARTH.getTotal | getTotal()}. For example:
   *
   * ```typescript
  ...
  /**
   * Calculate the result of an {@link TransactableARTH.openTrove | openTrove()} transaction.
   *
  ...
  /**
   * Calculate the parameters of an {@link TransactableARTH.openTrove | openTrove()} transaction
  ...
  /**
   * Calculate the result of an {@link TransactableARTH.adjustTrove | adjustTrove()} transaction
   * on this Trove.
   *
   * @param params - Parameters of the transaction.
  ...
  /**
   * Calculate the parameters of an {@link TransactableARTH.adjustTrove | adjustTrove()}
 ...
 * example to represent the {@link ReadableARTH.getTotal | total collateral and debt} locked up
 * in the protocol.
 *
