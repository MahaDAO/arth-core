...
export function finishCurrentRedemption(
  ...
  _attemptedARTHAmount: BigInt,
  _actualARTHAmount: BigInt,
  _ETHSent: BigInt,
  _ETHFee: BigInt
): void {
  ...
  currentRedemption.tokensAttemptedToRedeem = decimalize(_attemptedARTHAmount);
  currentRedemption.tokensActuallyRedeemed = decimalize(_actualARTHAmount);
  currentRedemption.collateralRedeemed = decimalize(_ETHSent);
  currentRedemption.partial = _actualARTHAmount < _attemptedARTHAmount;
